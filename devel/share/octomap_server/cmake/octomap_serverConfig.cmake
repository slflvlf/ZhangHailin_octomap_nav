...
if("TRUE" STREQUAL "TRUE")
  set(octomap_server_SOURCE_PREFIX /home/zhanglin/ship_gazebo_ws/src/octomap_mapping/octomap_server)
  set(octomap_server_DEVEL_PREFIX /home/zhanglin/ship_gazebo_ws/devel)
  ...
  set(octomap_server_INSTALL_PREFIX /home/zhanglin/ship_gazebo_ws/install)
...
if(NOT "/home/zhanglin/ship_gazebo_ws/devel/include;/home/zhanglin/ship_gazebo_ws/src/octomap_mapping/octomap_server/include " STREQUAL " ")
  set(octomap_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/zhanglin/ship_gazebo_ws/devel/include;/home/zhanglin/ship_gazebo_ws/src/octomap_mapping/octomap_server/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'octomap_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zhanglin/ship_gazebo_ws/src/octomap_mapping/octomap_server/${idir}'.  ${_report}")
    endif()
    _list_append_unique(octomap_server_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "octomap_server")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zhanglin/ship_gazebo_ws/devel/lib;/opt/ros/noetic/lib)
